...
export const createAndSendEmail = async (email,buffer,savedPath) => {
  try {
    // send mail with defined transport object
    const info = await transporter.sendMail({
      from: '"Fred Foo 👻" <foo@example.com>', // sender address
      to: `${email}`, // list of receivers
      subject: "Download Translations Excel..!", // Subject line
      text: "Chick the below link to download you excel file which you have requested.", // plain text body
      attachments: [
        {
                                ...
                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                      ...
                                      <tr>
                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                          ...
                                          <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
                                            The file which you have requested for download is here. It contain all the information of
                                            transactions. You can find that file in attached section of can download from download buttom below 👇 .
                                          </p>
                                          <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                            <tbody>
                                              <tr>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;" align="center" bgcolor="#0d6efd">
                                                  <a targate="_blank" href="${savedPath}" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Download</a>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                  ...
                                  <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                    <tbody>
                                      <tr>
                                        <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                          <img class="w-40" src="https://lh5.googleusercontent.com/w6bzkLmOXex43YQE7kr2A9qz3CbWNuJPmiEPWys9fPT6GR_g3cBrLVX7MAmgBTSHYdub_Otdb5K0PIeeoT0PtOQwW9F-STRa7dQZmK-GuGVULE53N8bVB4Mllb_DFNbAK3nkFrhn_KfT2stEiJ2DlvhFiybsNc57cFhuX_CsyhJepAARVz2Nkn8HnVysnQ" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 160px; border-style: none; border-width: 0;" width="160">
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
